                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            @if(Auth::user()->email_verified_at)
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('product') }}">@lang("main.products")</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('tag') }}">@lang("main.tags")</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('weather') }}">@lang("main.weather")</a>
                                </li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="{{ route("locale",__("main.set_lang"))}}"
                                       >
                                       {{__("main.set_lang")}}
                                        </a>
