...
@section("title","User" . " " . $product->product)
...
<div class="card" style="width: 18rem;">
  <ul class="list-group list-group-flush">
    ...
    <form method="POST" class=" list-group" action="{{route('destroy', $user)}}">
        <a class="btn btn-warning list-group-item rounded-0" href="{{route('edit', $user)}}" role="button"><i class="fas fa-pencil-alt p-1"></i>Edit</a>
        @csrf
        @method("DELETE")
